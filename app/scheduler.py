...
from app.scheduler.lotto_store_crawler_for_scheduling import update_all_lotto_stores
from app.scheduler.lotto_winning_crawler_for_scheduling import update_all_winning_data
